...
class TestPokemonBase(TesterBase):
    ...
    def test_get_hp(self):
        """Test get hp"""
        t1 = DummyAbstract(0, "FIRE")
        t2 = DummyAbstract(0, "FIRE")
    ...
    def test_set_hp(self):
        ...
        try:
            self.assertEqual(t1.set_hp(7), None, msg="set hp test failed")
        except AssertionError as e:
            self.verificationErrors.append(e)
    ...
    def test_set_poke_type(self):
        ...
        try:
            self.assertEqual(t1.set_poke_type("FIRE"), None, msg="set poke type test failed")
        except AssertionError as e:
            self.verificationErrors.append(e)
    ...
    def test_charmander_str(self):
        """Test string of Charmander"""
        t1 = DummyAbstract(0, "FIRE")

        try:
            s = str(t1)
            if s != "Charmander's HP = 0 and level = 1":
    ...
    def test_bulbasaur_str(self):
        """Test string of Bulbasaur"""
        t1 = DummyAbstract(9, "GRASS")
    ...
    def test_squirtle_str(self):
        """Test string of Squirtle"""
        t1 = DummyAbstract(8, "WATER")
