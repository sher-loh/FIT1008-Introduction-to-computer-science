"""task5_tester.py: Holds the tests for task 5 : Optimised mode battle"""
...
class TestTask4(TesterBase):
    ...
    def test_battle_example(self):
        ...
        try:
            assert str(
                b.team1) == "Bulbasaur's HP = 6 and level = 1, Bulbasaur's HP = 5 and level = 2, Squirtle's HP = 2 and level = 1"
        except AssertionError:
